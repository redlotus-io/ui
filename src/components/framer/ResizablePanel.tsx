...
const FormButton = ({ children, className, ...rest }: any) => {
  const { status } = useContext(formContext) as any;
...
const Form = ({ onSubmit, afterSave, children, ...props }: any) => {
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="mt-8 text-right">
                          <FormButton className="rounded bg-indigo-500 px-5 py-2 text-sm font-medium text-white ">
                            Email me my link
                          </FormButton>
                        </div>
                      </Form>
